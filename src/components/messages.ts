export const labels: Record<string, string> = {
  ...
  importLinks: 'label.import-links',
  import: 'label.import',
  importing: 'label.importing',
  invalidSlug: 'label.invalid-slug',
  customDomains: 'label.custom-domains',
  addDomain: 'label.add-domain',
  verified: 'label.verified',
  pending: 'label.pending',
  verify: 'label.verify',
  cnameRecord: 'label.cname-record',
  defaultDomain: 'label.default-domain',
  trackingDomain: 'label.tracking-domain',
  deleteDomain: 'label.delete-domain',
...
export const messages: Record<string, string> = {
  ...
  importLinksHelp: 'message.import-links-help',
  customDomainsDescription: 'message.custom-domains-description',
  cnameInstructions: 'message.cname-instructions',
